        ...
        <div class="content">
            ...
            <section class="content-section">
                ...
                <div class="table-wrapper">
                    <table class="holerite-table data-table">
                        <thead>
                        <tr>
                            <th>Referência</th>
                        ...
                        if (empty($holerites)): ?>
                            <tr>
                                <td colspan="4" class="empty-message" style="text-align: center;">Nenhum holerite encontrado.</td>
                            </tr>
                        <?php else:
            ...
            <div class="info-text">
                <p style="color: #5D6063;">Para dúvidas sobre seus pagamentos, por favor, entre em contato com o RH.</p>
            </div>
        </div>
    </div>
